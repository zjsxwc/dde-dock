...
QT_MOC_LITERAL(6, 61, 3) // "url"
    ...
    "removeApp\0appKey\0moveToTrash\0url"
};
...
void TrashWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TrashWidget *_t = static_cast<TrashWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestContextMenu(); break;
        case 1: _t->removeApp((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->moveToTrash((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TrashWidget::*_t)() const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TrashWidget::requestContextMenu)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TrashWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TrashWidget.data,
      qt_meta_data_TrashWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TrashWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TrashWidget.stringdata0))
        return static_cast<void*>(const_cast< TrashWidget*>(this));
...
{
    QMetaObject::activate(const_cast< TrashWidget *>(this), &staticMetaObject, 0, Q_NULLPTR);
}
