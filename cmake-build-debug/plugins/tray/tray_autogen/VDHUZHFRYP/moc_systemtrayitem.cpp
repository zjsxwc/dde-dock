...
QT_MOC_LITERAL(1, 15, 21), // "onContextMenuAccepted"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "SystemTrayItem\0onContextMenuAccepted\0"
    ""
};
...
void SystemTrayItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SystemTrayItem *_t = static_cast<SystemTrayItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onContextMenuAccepted(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject SystemTrayItem::staticMetaObject = {
    { &AbstractTrayWidget::staticMetaObject, qt_meta_stringdata_SystemTrayItem.data,
      qt_meta_data_SystemTrayItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SystemTrayItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SystemTrayItem.stringdata0))
        return static_cast<void*>(const_cast< SystemTrayItem*>(this));
