...
QT_MOC_LITERAL(1, 13, 22), // "requestPlaySoundEffect"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 9) // "onTimeout"

    },
    "VolumeSlider\0requestPlaySoundEffect\0"
    "\0onTimeout"
};
...
void VolumeSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->requestPlaySoundEffect(); break;
        ...
        {
            typedef void (VolumeSlider::*_t)() const;
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VolumeSlider::requestPlaySoundEffect)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VolumeSlider::requestPlaySoundEffect()const
{
    QMetaObject::activate(const_cast< VolumeSlider *>(this), &staticMetaObject, 0, Q_NULLPTR);
}
